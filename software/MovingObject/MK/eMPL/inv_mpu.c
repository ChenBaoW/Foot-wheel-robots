...
#if defined STM32F103xB													//这个在keil的魔术棒中已经宏定义了, 不同的型号生成不同的宏定义, 
...
#define get_ms      f4_get_tick_ms_cnt					//时间戳
...
/* ----------------------------- USER CODE END 1 ------------------------------ */
#elif defined MOTION_DRIVER_TARGET_MSP430				//将MSP430和自己的芯片型号作唯一的选择, #if --> #elif
/* ----------------------------- USER CODE END 2 ------------------------------ */
